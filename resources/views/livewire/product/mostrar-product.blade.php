                      ...
                      @forelse ($products as $product)
                          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                              ...
                              <td class="flex justify-center px-6 py-4 space-x-4 text-center">
                                ...
                                <button wire:click="confirmDeleteProduct({{ $product->id }})" class="flex justify-center gap-2 px-2 py-2 text-xs font-bold text-white uppercase bg-red-700 rounded-lg hover:scale-90">
